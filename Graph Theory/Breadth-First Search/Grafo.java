...
public class Grafo {
    ...
    public static void main(String[] args){
        ...
        BuscaLargura busca = new BuscaLargura(pointer, arcDest);
        System.out.println("Busca em largura realizada com êxito!\nForam visitados "+busca.buscaBipartido()+" vértices");
